...
public class BanCommand extends SubCommand {
    ...
    public void execute(CommandContext<ServerCommandSource> context) {
        ...
        try {
            ...
            if (success) {
                source.sendFeedback(() -> Text.of("§b[Tebex] §7Player banned successfully."), false);
            } else {
                source.sendFeedback(() -> Text.of("§b[Tebex] §7Failed to ban player."), false);
            }
        } catch (InterruptedException | ExecutionException e) {
            source.sendFeedback(() -> Text.of("§b[Tebex] §7Error while banning player: " + e.getMessage()), false);
        }
    }
